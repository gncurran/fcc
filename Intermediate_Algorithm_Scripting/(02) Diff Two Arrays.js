function diff(arr1, arr2) {
  ...
  function check(elem) {                                                    // create a function to:
  ...
  return combined.filter(check);                                            // returned a new array populated with the elements that passed the check function we created
}
